...
test.describe("farm futures (NUT-32 spike)", () => {
  ...
  // The claims portal shares the redemption module with the wallet
  // panel (runFarmRedemption); its unique surface — paste import,
  // date-aware verdict, and now VIRTUAL delivery — is pinned here.
