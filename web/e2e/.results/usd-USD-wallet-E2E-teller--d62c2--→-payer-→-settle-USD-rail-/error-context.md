...
- Name: usd.spec.ts >> USD wallet E2E (teller + lightning) >> onchain deposit: address → payer → settle (USD rail)
- Location: e2e/usd.spec.ts:26:3
...
Call log:
  - waiting for locator('[data-testid="deposit-card"]').filter({ hasText: 'sat (signet) to:' }) to be visible

```

```
Error: wallet console errors:
  - console: Failed to load resource: the server responded with a status of 400 () (https://giftcard.cashu.exchange/usd/v1/mint/quote/btc)
  ...
  - main [ref=e3]:
    ...
    - generic [ref=e28]:
      ...
      - generic [ref=e34]:
        ...
        - generic [ref=e55]:
          - paragraph [ref=e56]: E2E usd payout
    ...
    - paragraph [ref=e96]:
      ...
      - link "Operator console" [ref=e97] [cursor=pointer]:
        - /url: https://giftcard.cashu.exchange/usd-console/
      - text: ·
      - link "Teller" [ref=e98] [cursor=pointer]:
        - /url: https://giftcard.cashu.exchange/usd-console/teller
